...
<img alt="Icon" width=100 src="./common/src/main/resources/assets/moremousetweaks/icon.png">

## MoreMouseTweaks

Enhances [Mouse Tweaks](https://modrinth.com/project/aC3cM3Vq) by adding extra mouse functions.
...
[![Available on Modrinth](https://img.shields.io/modrinth/dt/S8drsznD?label=Available%20on%20Modrinth&logo=modrinth&logoColor=%2300AF5C)](https://modrinth.com/project/S8drsznD)
[![Available on CurseForge](https://img.shields.io/curseforge/dt/1134081?label=Available%20on%20CurseForge&logo=curseforge)](https://curseforge.com/minecraft/mc-mods/moremousetweaks)
[![Available on GitHub](https://img.shields.io/github/downloads/TerminalMC/ClientSort/total?label=Available%20on%20GitHub&logo=github&logoColor=white)](https://github.com/TerminalMC/MoreMouseTweaks)

</center></div>

### Tweaks

- `ALT+LMB` to drop a slot
  - Equivalent of vanilla `CTRL+Q`
  - Works with mouse dragging
  - `CTRL+ALT+LMB` to drop all matching slots


- `CTRL+LMB` to quick-move all matching slots
  - Equivalent of vanilla `SHIFT+DOUBLE_LMB`
  - Works with mouse dragging
...
- Configurable keybinds
  - Drop key (default: `ALT`)
  - Matching slots key (default: `CTRL`)
  - `SHIFT` is used by vanilla bulk-crafting and is not configurable


- Configurable item matching
  - Item component data can be ignored on a per-tag basis

### Dependencies

Fabric: [MouseTweaks](https://modrinth.com/project/aC3cM3Vq), [Fabric API](https://modrinth.com/project/P7dR8mSH), [ModMenu](https://modrinth.com/project/mOgUt4GM), [Cloth Config API](https://modrinth.com/project/9s6osm5g)

NeoForge: [MouseTweaks](https://modrinth.com/project/aC3cM3Vq), [Cloth Config API](https://modrinth.com/project/9s6osm5g)

### Credits

MoreMouseTweaks is derived from [Mouse Wheelie](https://github.com/Siphalor/mouse-wheelie) by
[Siphalor](https://github.com/Siphalor), and includes code reused under license.

### Related Mods

- [ClientSort](https://modrinth.com/project/S8drsznD) - inventory sorting and transfer operations.
