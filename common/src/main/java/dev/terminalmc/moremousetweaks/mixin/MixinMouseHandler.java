...
/**
 * Previously used a WrapMethod around
 * {@link yalter.mousetweaks.Main#onMouseScrolled} but that doesn't fire on
 * creative inventory scroll on NeoForge due to how they implement the event.
 */
...
public class MixinMouseHandler {
    ...
    private boolean wrapMouseScroll(Screen screen, double mouseX, double mouseY,
                                    double deltaX, double deltaY, Operation<Boolean> original) {
        ScrollAction result;
